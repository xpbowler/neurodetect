...
#RNA-seq data from The Cancer Genome Atlas Program (TCGA). BRCA - Breast Invasive Carcinoma
query <- GDCquery(
  project = "TCGA-BRCA",data.category = "Sequencing Reads",data.type = "Gene Expression Quantification",
  platform = "Illumina HiSeq", experimental.strategy = "RNA-Seq", legacy = FALSE)
